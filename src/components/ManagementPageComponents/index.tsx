import { Box, Button, Flex, Grid, GridItem, useColorMode } from "@chakra-ui/react";
          ...
          <Box
            ...
            sx={{
              ...
              '&::-webkit-scrollbar-track': {
                backgroundColor: colorMode === 'dark' ? 'dark.200' : 'green.150',
              },
              '&::-webkit-scrollbar-thumb': {
                backgroundColor: colorMode === 'dark' ? 'light.100' : 'green.200',
                borderRadius: '10px',
                border: '4px solid' + colorMode === 'dark' ? 'dark.200' : 'green.150'
              }
            }}
          >
            <Flex
