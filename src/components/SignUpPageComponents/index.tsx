import { Button, FormControl, FormLabel, Heading, Input, Link, Text, useColorMode, useToast } from "@chakra-ui/react";
        ...
        onClick={() => {
          ...
          api.post('/users', {
            ...
            .catch((e) => {
              ...
              if (Array.isArray(e.response.data.message) && e.response.status === 400) {
                toast({
                  title: 'Não foi possível criar o usuário',
              ...
              if (e.response.status === 500) {
                toast({
                  title: 'Não foi possível criar o usuário, problema no servidor',
                  description: 'Pedimos desculpas pelo ocorrido, tente novamente mais tarde!',
                  status: 'error',
                  position: 'top-right',
                  isClosable: true
                });
